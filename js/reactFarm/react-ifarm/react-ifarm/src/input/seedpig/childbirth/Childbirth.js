...
let pageIndex = 0;
class Childbirth extends React.Component{
  ...
  constructor(props) {
    ...
    this.genData = () => {
      ...
      this.lastPage =page
      const url = config.BASIC_URL+'/testapi/childbirth?_limit='+config.PAGE_SIZE+'&_page='+page
...
export default connect(mapStateToProps)(Childbirth)
