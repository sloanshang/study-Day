...
let pageIndex = 0;
class Ablactation extends React.Component{
  ...
  constructor(props) {
    ...
    this.genData = () => {
      ...
      this.lastPage =page
      const url = config.BASIC_URL+'/testapi/ablactation?_limit='+config.PAGE_SIZE+'&_page='+page
...
export default connect(mapStateToProps)(Ablactation)
